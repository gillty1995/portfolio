...
import AnimatedInput from "@/components/AnimatedInput"; // adjust path as needed
...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col items-center justify-center py-20 px-4"
    >
      <motion.div
